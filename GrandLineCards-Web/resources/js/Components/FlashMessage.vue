...
<template>
    ...
    >
        <div v-if="show" class="fixed top-20 right-4 z-50 max-w-sm w-full bg-grand-800 border shadow-lg rounded-lg pointer-events-auto ring-1 ring-black ring-opacity-5 overflow-hidden"
             :class="{
            ...
            <div class="p-4">
                <div class="flex items-start">
                    ...
                    <div class="ml-4 flex-shrink-0 flex">
                        <button @click="close" class="bg-transparent rounded-md inline-flex text-gray-400 hover:text-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-grand-gold">
